...
import { mouCompanies } from "./data";

export default function PlacementMOUPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      {/* 5. Placement Recruiters Content */}
      <main className="flex-grow max-w-[1200px] mx-auto w-full px-4 py-12">
        <div className="bg-white p-8 md:p-12 border border-gray-200 shadow-sm rounded">
          <div className="text-center mb-12">
            <h2 className="text-[#293d6b] text-4xl font-bold mb-4 border-b-4 border-red-600 inline-block pb-3" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
              MOU Signed Companies
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              We had Signed Memorandum Of Understanding (MoU) with the following Prestigious Companies
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            {mouCompanies.map((company, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 p-6 flex flex-col items-center justify-center text-center h-auto min-h-[14rem] group">
                ...
                <h3 className="text-[#293d6b] font-bold text-sm leading-snug">
                  {company.name}
                </h3>
              </div>
            ))}
