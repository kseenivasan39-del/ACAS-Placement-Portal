...
import { Bell, CheckCircle2, Clock, Calendar, Check, Users } from "lucide-react";
import { useState } from "react";

export default function RecruiterNotificationsPage() {
  const [notifications, setNotifications] = useState([
    { id: 1, type: "approved", title: "Drive Approved", message: "The Placement Office has APPROVED your SDE-1 drive request. It is now live.", time: "10 mins ago", unread: true },
    { id: 2, type: "applications", title: "New Applications Received", message: "15 new students have applied to your Frontend Developer role.", time: "1 hour ago", unread: true },
    { id: 3, type: "interview", title: "Interview Slot Confirmed", message: "Rahul S. has confirmed their technical interview slot for Thursday at 2 PM.", time: "2 hours ago", unread: false },
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'applications': return <Users size={18} className="text-blue-600" />;
  ...
  const getColor = (type: string) => {
    switch (type) {
      ...
      case 'applications': return 'bg-blue-100 border-blue-200';
