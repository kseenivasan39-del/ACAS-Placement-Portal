      ...
      <div className="bg-[#384a6c] text-white text-xs py-1.5 px-4 font-semibold tracking-wide border-b-2 border-black/10">
        <div className="max-w-[1400px] mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <span className="pr-3">Welcome, HR Manager (Tata Consultancy Services)</span>
          </div>
      ...
      <header className="bg-white py-4 px-4 border-b border-gray-200 shadow-sm">
        <div className="max-w-[1400px] mx-auto flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-[#1a2b54] font-bold text-sm">Placement Portal - Recruiter Dashboard</p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1400px] mx-auto w-full px-4 py-8 flex-grow flex flex-col md:flex-row gap-6">
          ...
          <div className="bg-white border border-gray-200 rounded overflow-hidden">
            ...
            <ul className="divide-y divide-gray-200 text-sm font-semibold text-gray-700">
              ...
              <li className="p-3 hover:bg-gray-50 hover:text-blue-800 cursor-pointer flex items-center gap-2">
                <Briefcase size={16} /> Manage Drives
              </li>
              <li className="p-3 hover:bg-gray-50 hover:text-blue-800 cursor-pointer flex items-center gap-2">
        ...
        <div className="flex-grow">
          ...
          <div className="bg-white border border-blue-200 rounded p-4 mb-6 shadow-sm border-t-4 border-t-[#293d6b]">
            <h3 className="font-bold text-[#293d6b] border-b border-gray-200 pb-2 mb-3">TCS RECRUITMENT DRIVE OVERVIEW</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="text-2xl font-bold text-[#293d6b]">342</p>
                <p className="text-xs font-bold text-gray-500 uppercase mt-1">Applications</p>
              </div>
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="text-2xl font-bold text-[#293d6b]">85</p>
                <p className="text-xs font-bold text-gray-500 uppercase mt-1">Shortlisted</p>
              </div>
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="text-2xl font-bold text-[#293d6b]">24</p>
                <p className="text-xs font-bold text-gray-500 uppercase mt-1">Interviews</p>
              </div>
              <div className="bg-gray-50 p-3 border border-gray-200 rounded">
                <p className="text-2xl font-bold text-green-600">12</p>
                <p className="text-xs font-bold text-gray-500 uppercase mt-1">Selected</p>
              </div>
            </div>
          </div>
              ...
              <table className="w-full text-sm text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50">
                    <td className="p-3 border-r border-gray-200 text-gray-500">24CS001</td>
                    <td className="p-3 border-r border-gray-200 font-bold text-[#293d6b]">Arun Kumar M</td>
                    <td className="p-3 border-r border-gray-200 text-gray-700">B.Sc Computer Science</td>
                    <td className="p-3 border-r border-gray-200 font-bold">8.5</td>
                    <td className="p-3 border-r border-gray-200"><span className="text-blue-600 font-bold">Applied</span></td>
                    <td className="p-3 text-center">
                      <button className="text-[#293d6b] hover:underline font-bold text-xs">View Resume</button>
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="p-3 border-r border-gray-200 text-gray-500">24BCA042</td>
                    <td className="p-3 border-r border-gray-200 font-bold text-[#293d6b]">Priya Darshini S</td>
                    <td className="p-3 border-r border-gray-200 text-gray-700">BCA</td>
                    <td className="p-3 border-r border-gray-200 font-bold">9.1</td>
                    <td className="p-3 border-r border-gray-200"><span className="text-green-600 font-bold">Shortlisted</span></td>
                    <td className="p-3 text-center">
                      <button className="text-[#293d6b] hover:underline font-bold text-xs">View Resume</button>
                    </td>
                  </tr>
