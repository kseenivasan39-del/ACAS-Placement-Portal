    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow max-w-[1000px] mx-auto w-full px-4 py-12">
        <div className="bg-white p-8 md:p-12 border border-gray-200 shadow-sm rounded">
          ...
          <div className="text-gray-800 leading-relaxed space-y-6 text-lg text-justify mb-16">
            <p className="bg-gray-50 p-6 rounded border border-gray-100 shadow-sm">
              The Placement Cell at <span className="font-bold">Dr. Sivanthi Aditanar College of Engineering, Tiruchendur</span> acts as a bridge between students and industry, preparing graduates to meet the demands of the professional world. We focus on holistic career development by enhancing technical knowledge, communication skills, and employability through continuous training and guidance. Our strong industry collaborations and alumni network ensure excellent placement opportunities for our students.
            </p>
          </div>
